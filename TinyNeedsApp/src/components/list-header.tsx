...
export const ListHeader = ({
  ...
  const displayName = user?.email ? user.email.split('@')[0] : 'Parent';
      ...
      <View style={styles.quickActions}>
        <Link href='/(shop)/orders' asChild>
          <Pressable style={styles.quickAction}>
            <FontAwesome name='book' size={18} color='#1BC464' />
            <Text style={styles.quickActionText}>Orders</Text>
          </Pressable>
        </Link>
        <Link href='/(shop)/baby-care' asChild>
          <Pressable style={styles.quickAction}>
            <FontAwesome name='heart' size={18} color='#1BC464' />
            <Text style={styles.quickActionText}>Baby Care</Text>
          </Pressable>
        </Link>
      </View>
